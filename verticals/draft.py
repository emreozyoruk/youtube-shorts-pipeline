...
def generate_draft(
    ...
    lang_names = {"en": "English", "tr": "Turkish", "hi": "Hindi", "es": "Spanish", "pt": "Portuguese", "de": "German", "fr": "French", "ja": "Japanese", "ko": "Korean"}
    lang_name = lang_names.get(lang, "English")
    lang_instruction = f"\n\nIMPORTANT: Write the ENTIRE script, title, description, tags, and captions in {lang_name}. All output text must be in {lang_name}." if lang != "en" else ""
